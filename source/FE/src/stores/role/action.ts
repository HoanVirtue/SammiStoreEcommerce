...
export const getAllRolesAsync = createAsyncThunk('role/get-all', async (data: { params: TParamsGetAllRoles }) => {
...
export const updateRoleAsync = createAsyncThunk('role/update', async (data: TParamsUpdateRole) => {
