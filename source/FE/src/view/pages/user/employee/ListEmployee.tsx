  ...
  const columns: GridColDef[] = [
    {
      ...
      flex: 1,
      minWidth: 200,
      renderCell: (params: GridRenderCellParams) => <Typography>{params.row.username}</Typography>,
    },
    {
      field: "employee_code",
    ...
    },
    {
      ...
      minWidth: 200,
      maxWidth: 200,
      renderCell: (params: GridRenderCellParams) => <Typography>{params.row.gender}</Typography>,
    },
