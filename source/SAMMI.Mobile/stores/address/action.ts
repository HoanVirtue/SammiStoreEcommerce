...
//services
import { createAddress, deleteMultipleAddresses, deleteAddress, getAllAddresses, updateAddress, getCurrentAddress } from "@/services/address";

//types
import { TParamsCreateAddress, TParamsDeleteMultipleAddresses, TParamsGetAllAddresses, TParamsUpdateAddress } from "@/types/address";
