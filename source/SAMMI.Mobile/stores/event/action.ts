...
//services
import { createEvent, deleteMultipleEvents, deleteEvent, getAllEvents, updateEvent, getEventCode } from "@/services/event";

//types
import { TParamsCreateEvent, TParamsDeleteMultipleEvents, TParamsGetAllEvents, TParamsUpdateEvent } from "@/types/event";
