...
import { createCustomer, deleteCustomer, deleteMultipleCustomers, getAllCustomers, updateCustomer } from "../../services/customer";

//service
import { TParamsCreateCustomer, TParamsDeleteMultipleCustomers, TParamsGetAllCustomers, TParamsUpdateCustomer } from "../../types/customer";
...
export const deleteCustomerAsync = createAsyncThunk(`${serviceName}/delete`, async (id: string) => {
