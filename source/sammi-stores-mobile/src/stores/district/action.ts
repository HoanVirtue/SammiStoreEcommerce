...
//services
import { createDistrict, deleteMultipleDistricts, deleteDistrict, getAllDistricts, updateDistrict } from "../../services/district";
...
export const deleteDistrictAsync = createAsyncThunk(`${serviceName}/delete`, async (id: string) => {
